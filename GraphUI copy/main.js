document.addEventListener('DOMContentLoaded', () => {
    ...
    submitButton.addEventListener('click', async () => {
        ...
        if (text) {
            ...
            try {
                ...
                const response = await fetch('http://localhost:5001/api/graph_call', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
    ...
    confirmButton.addEventListener('click', async () => {
        ...
        try {
            ...
            try {
                const llmResponse = await fetch('http://localhost:5001/api/call_llm', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
            ...
            // Save chat history
            try {
                const historyResponse = await fetch('http://localhost:5001/api/save_history', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
