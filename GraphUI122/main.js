        ...
        if (text && graphManager.oldGraph) {
            ...
            try {
                ...
                if (result.status === "success" && result.graph) {
                    ...
                    graphManager.oldGraphSvg.dispatch("tick");
                    ...
                    graphManager.currentGraphSvg.dispatch("tick");
    ...
    submitButton.addEventListener('click', async () => {
        ...
        if (text) {
            ...
            try {
                ...
                setTimeout(()=>{
                    oldsvg.append('text').attr('x', 10).attr('y', 20).text('fuck you');
                },2000)
                ...
                setTimeout(()=>{
                    newsvg.append('text').attr('x', '250').attr('y', '300').style('fill', 'black').text('hahahah')
                }, 5000)
