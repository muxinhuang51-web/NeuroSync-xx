...
# Significance legend with clear title
...
# Add legends with improved significance legend title
...
sig_legend1 = fig.legend(handles=significance_legend_elements, loc='lower center', 
                         bbox_to_anchor=(0.25, 0.01), framealpha=0.9, ncol=2, 
                         fontsize=8, title='Statistical Significance')
