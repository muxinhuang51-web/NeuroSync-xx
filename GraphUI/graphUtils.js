class GraphManager {
    ...
    renderGraph(svg, graph, isEditable, isInitialRender = false, previewScale = 1, commonNodeIds = null, disableExtension = false, disableEditing = false, modifiedNodeIds = null) {
        ...
        const nodeWidth = 130 * previewScale;  // CHANGE: Same width regardless of preview
        ...
        if (isInitialRender) {
            ...
            // Also manually call ticked() several times for immediate edge updates
            for (let i = 0; i < 10; i++) {
                ticked();
            }
        } else {
        ...
        // Always call ticked() one final time to ensure all edges are properly positioned
        ticked();
